...
export default function App() {
  ...
  useEffect(() => { void load(); }, []);
  // Only once an area is selected, so an incoming #area=... link is not overwritten before it loads.
  useEffect(() => { if (selected) writeView({ area: selected.geo_id, tab }); }, [selected?.geo_id, tab]);
  useEffect(() => {
